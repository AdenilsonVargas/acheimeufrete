/**
 * Utilitário para trabalhar com horários de Brasília no frontend
 * Sincronizado com o backend (brazilTime.js)
 */
...
export const validarHorarioChat = () => {
  ...
  return {
    ...
    mensagem: permitido 
      ? 'Chat disponível'
      : `Chat indisponível. Horário de funcionamento: 08:00-17:00 (Brasília). Hora atual: ${String(horaBrasilia).padStart(2, '0')}:00`
  };
};
