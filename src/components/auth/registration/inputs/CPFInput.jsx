...
import { validateCPFInput, isValidCPF, formatCPF } from '@/utils/validators';
...
export default function CPFInput({
  ...
  const handleChange = (e) => {
    ...
    const result = validateCPFInput(inputValue);
  ...
  const handleBlur = (e) => {
    ...
    const result = validateCPFInput(e.target.value);
    setValidation(result);
